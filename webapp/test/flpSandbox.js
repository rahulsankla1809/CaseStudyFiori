		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Monitor Purchase Order",
									"targetURL": "#MonitorPurchaseOrder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MonitorPurchaseOrder-display": {
								"semanticObject": "MonitorPurchaseOrder",
								"action": "display",
								"description": "Monitor Purchase Order",
								"title": "Monitor Purchase Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.test.demomonitorpurchaseorder",
									"url": sap.ui.require.toUrl("com/test/demomonitorpurchaseorder")
								}
							}
						}
					}
