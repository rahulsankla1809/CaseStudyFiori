...
sap.ui.define([
	...
	"com/test/demomonitorpurchaseorder/test/flpSandbox"
	...
	return Opa5.extend("com.test.demomonitorpurchaseorder.test.integration.arrangements.FLP", {
		/**
		...
		iRestartTheAppWithTheRememberedItem: function (oOptions) {
			this.waitFor({
				success: function () {
					...
					oOptions.hash = "PurchaseOrderMonitorSet/" + encodeURIComponent(sObjectId);
